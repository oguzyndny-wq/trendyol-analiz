...
st.set_page_config(page_title="Konsolide E-Ticaret Yapay Zeka Paneli v7.5", layout="wide")

st.title("🤖 Çok Kanallı (Trendyol & Amazon) Akıllı Yapay Zeka Paneli v7.5")
...
# GÜVENLİ SAYI MOTORU VE AKILLI VERİ TAMİRİ
def clean_number(val, is_amazon_summary_field=False):
    ...
    # Excel tarafından tarihe bozulmuş sayıları geri kurtarma formülü (Örn: 4107-06-01 -> 4107.06)
...
if baslat_btn:
    ...
    # 💛 AMAZON HESAPLAMA MOTORU + UYUMLAŞTIRMA KATMANI
    if amazon_file and amazon_maliyet_file:
        try:
            ...
            cost_col = 'Birim Alış Maliyeti (₺)' if 'Birim Alış Maliyeti (